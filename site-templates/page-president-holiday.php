...
// Snowfall plugin: http://www.jqueryrain.com/?kn4rXFeL
...
// Custom options for the snowflake plugin
...
// Custom options for the page scroll plugin
...
body {
    font-size: 14px !important; /* Overwrites  */
    background: url('/cms/president/wp-content/themes/uw-2013/img/misc/template-holiday/gerb.jpg') no-repeat center center fixed;
...
.scroll {
    background: url('/cms/president/wp-content/themes/uw-2013/img/misc/template-holiday/scroll-1.png') 0 0 no-repeat;
    bottom: 110px;
}
.scroll-1 {
    background: url('/cms/president/wp-content/themes/uw-2013/img/misc/template-holiday/scroll-2.png') top center no-repeat;    
    bottom: 50px;
}
.holiday-logo {
    position: absolute;
...
.holiday-message {
    background: url('/cms/president/wp-content/themes/uw-2013/img/misc/template-holiday/message-bg.png') 0 0 no-repeat;
    position: absolute;
    top: 270px;
    width: 747px;
    height: 488px;
...
#menu-dots li {
    ...
    color: #000;
    font-weight: 700;
    background: url('/cms/president/wp-content/themes/uw-2013/img/misc/template-holiday/nav-dots.png') 0 4px no-repeat;
    padding: 0 0 0 26px;
    margin: 0 0 7px 0;
}
#menu-dots li.active {
...
#menu-dots li a, #menu li.active a {
    display: block;
}
iframe {
    margin-left: -426px;
