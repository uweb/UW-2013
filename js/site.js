  ...
  $.fn.tinyNav = function (options) {
    ...
    return this.each(function () {
      ...
      if ($nav.is('ul,ol')) {
        ...
        // Inject select
        $('#primary').before($select);
                
        // Wrap in div        
        $($select).wrap('<div class="mobile-select" />');
...
/* **********************************************
     Begin dropdowns-accessibility.js
********************************************** */
...
/* **********************************************
     Begin jquery.fullcalendar.gcal.js
********************************************** */
...
//@codekit-prepend "weather.js"
//@codekit-prepend "thin-strip.js"
...
// widgets
//@codekit-prepend "widgets/community-photos.js"
//@codekit-prepend "widgets/slideshow.js"
